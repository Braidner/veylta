...
| Same-profile repeat upload creates no duplicate | Lifecycle integration and browser tests show that the same active SHA-256 reopens the existing logical document without a second job; cross-profile reuse remains an explicit separate record. |
