    ...
    async getProfileOverview(actor, requestedScope, correlationId) {
      ...
      return database.transaction(async (client) => {
        ...
        const reviewDocuments = await client.query<ProfileOverviewDocumentRow>(
          overviewDocumentsSql({
            onlyAwaitingReview: true,
        ...
        const response: ProfileOverviewResponse = {
          ...
          outsideIndicatorCount: asCount(reading.indicators.outside, "overview outside indicators"),
          withinIndicatorCount: asCount(reading.indicators.within, "overview within indicators"),
          unknownIndicatorCount: asCount(reading.indicators.unknown, "overview unknown indicators"),
