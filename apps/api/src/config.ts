...
export function loadConfig(): RuntimeConfig {
  ...
  const codexDocumentTimeoutMs = boundedInteger("CODEX_DOCUMENT_TIMEOUT_MS", 600_000, 600_000);
  const processingLeaseDurationMs = integer("PROCESSING_LEASE_DURATION_MS", 660_000);
