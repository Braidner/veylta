...
const rules = [
  ...
  "Urgency is mandatory and comes first: emergency when the evidence can mean an immediate danger to life or organ (say so plainly and tell the person to seek emergency care now); urgent when a clinician should be seen within days; soon within weeks; routine at the next planned visit; none when there is nothing to act on. Do not soften urgency to be reassuring, and do not inflate it to be safe — name the reasons.",
