...
const instructions = [
  ...
  "The answer may come from the physician assistant, from the nutrition assistant («ИИ-нутрициолог») or from the training assistant («ИИ-тренер»); judge diet_assessment, diet_recommendation, activity_assessment, activity_recommendation and recheck blocks the same way — against the evidence and against the recorded conditions, medications, allergies, pregnancy, activity constraints and clearance — and mark a supplement or diet recommendation that carries a dose, an activity whose load exceeds a recorded clearance or contradicts a recorded constraint or the person's check-ins, or any block that contradicts an accepted plan item, as unsafe.",
