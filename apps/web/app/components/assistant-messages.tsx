...
const openers: Record<AssistantId, readonly string[]> = {
  ...
  trainer: [
    "Как мне тренироваться при таких значениях?",
    "Какая нагрузка безопасна без допуска врача, а для какой он нужен?",
    "Как прибавлять нагрузку по моим отметкам в плане?",
  ],
};
